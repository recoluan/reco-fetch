...
window.recoFetch = function (url) {
  var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {}; // 设置请求超时的时间，默认10秒
...
},{"../../utils/handleData.js":5}],3:[function(require,module,exports){
"use strict";
...
},{"../../utils/handleData.js":5}],4:[function(require,module,exports){
"use strict";
...
exports.formatUrl = formatUrl; // 对请求结果进行处理：fetch请求成功后返回的是json对象
